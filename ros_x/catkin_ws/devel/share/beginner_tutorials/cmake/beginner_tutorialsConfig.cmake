...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/cyber/repos/x/ros_x/catkin_ws/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/cyber/repos/x/ros_x/catkin_ws/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/cyber/repos/x/ros_x/catkin_ws/install)
...
if(NOT "/home/cyber/repos/x/ros_x/catkin_ws/devel/include " STREQUAL " ")
  set(beginner_tutorials_INCLUDE_DIRS "")
  set(_include_dirs "/home/cyber/repos/x/ros_x/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'cyberSJ <sungjoonkim4.0@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cyber/repos/x/ros_x/catkin_ws/src/beginner_tutorials/${idir}'.  Ask the maintainer 'cyberSJ <sungjoonkim4.0@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cyber/repos/x/ros_x/catkin_ws/devel/lib;/home/cyber/repos/x/ros_x/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
