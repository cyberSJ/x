...
class AveragingAction
{
    public:
            ...
            action_name_( name )
        {
            ...
            sub_ = nh_.subscribe( "/random_number", 
                                  1, 
    ...
    protected:
        ros::NodeHandle nh_;
        actionlib::SimpleActionServer<actionlib_x::AveragingAction> as_;
        std::string action_name_;
        int data_count_;
        int goal_;
        float sum_;
        float sum_sq_;
        actionlib_x::AveragingFeedback feedback_;
        actionlib_x::AveragingResult result_;
        ros::Subscriber sub_;
};
