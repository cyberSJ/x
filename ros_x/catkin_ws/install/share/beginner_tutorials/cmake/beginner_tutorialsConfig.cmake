...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cyber/repos/x/ros_x/catkin_ws/install/${idir}'.  Ask the maintainer 'cyberSJ <sungjoonkim4.0@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cyber/repos/x/ros_x/catkin_ws/install/lib;/home/cyber/repos/x/ros_x/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
